...
from cov19 import CoronaStats


def send_mail(total_cases, new_cases, total_deaths, active_cases, total_recovered, serious_critical):
    ...
    body += "<td width='200px'><center><span style='font-size: 24px;font-weight: bold; color:#d9c43b'>{mild_condition}</span><br><span style='font-size:13.5px'>Normal</span></center></td>".format(
        mild_condition=active_cases - serious_critical)
...
if __name__ == '__main__':
    ...
    total_cases, new_cases, total_deaths, active_cases, total_recovered, serious_critical = corona_stats.get_data()

    send_mail(total_cases, new_cases, total_deaths, active_cases, total_recovered, serious_critical)